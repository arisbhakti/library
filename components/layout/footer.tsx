      ...
      <div className="grid gap-6 px-4 py-8 lg:px-[120px] lg:py-10">
        <div className="grid justify-items-center gap-4">
          <Link className="flex items-center gap-2" href="/">
            <Image alt="Booky logo" height={33} src="/booky-logo.svg" width={33} />
          ...
          <p className="max-w-[680px] text-center text-sm text-neutral-700 lg:text-md">
            Discover inspiring stories & timeless knowledge, ready to borrow anytime. Explore online or visit our
            nearest library branch.
          </p>
          <div className="grid justify-items-center gap-2">
            <p className="text-md font-semibold text-neutral-950">Follow on Social Media</p>
